...
//
int lua_cocos2dx_ui_ScrollView_startRecordSlidAction(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::ScrollView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_ScrollView_startRecordSlidAction'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
            return 0;
        cobj->startRecordSlidAction();
        return 0;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "startRecordSlidAction",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_ScrollView_startRecordSlidAction'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_ScrollView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ScrollView");
        ...
        tolua_function(tolua_S,"stopAutoScrollChildren", lua_cocos2dx_ui_ScrollView_startRecordSlidAction);
    tolua_endmodule(tolua_S);
...
int lua_register_cocos2dx_ui_ListView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ListView");
        ...
        tolua_function(tolua_S,"addScrollViewEventListener",lua_cocos2dx_ui_ScrollView_addEventListener);
    tolua_endmodule(tolua_S);
