...
public class XLog {
     ...
     * 对外static调用
     */
    private static Logger instance = getLogger("unity_pay");
    ...
    private static class Logger {
        ...
        private int level = XLog.ERROR; // 默认级别
