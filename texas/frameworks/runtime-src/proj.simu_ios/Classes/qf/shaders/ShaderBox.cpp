...
void ShaderBox::getScreenBlurSprite(const std::function<void(bool, cocos2d::Sprite* sprite)>& afterCaptured, bool quarter, unsigned int radius)
{
    /*
...
void ShaderBox::getScreenGraySprite(const std::function<void(bool, cocos2d::Sprite* sprite)>& afterCaptured, bool quarter)
{
    shader::captureScreenToSpriteWithGrey(afterCaptured, quarter);
}

void ShaderBox::getScreenHighlightSprite(const std::function<void(bool, cocos2d::Sprite* sprite)>& afterCaptured, bool quarter, unsigned int increment)
{
