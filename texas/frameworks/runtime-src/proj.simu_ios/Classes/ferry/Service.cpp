...
namespace ferry {
    ...
    int Service::_createUnitySocket(std::string host, int port, netkit::SocketType &resultSock, std::string &address) {
    ...
    int Service::_createV4Socket(std::string host, int port, netkit::SocketType &resultSock, std::string &address) {
    ...
    int Service::_createV6Socket(std::string host, int port, netkit::SocketType &resultSock, std::string &address) {
