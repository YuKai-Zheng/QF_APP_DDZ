...
public:
     ...
     */
    void showWebView(const char* url, float x, float y, float width, float height , int cb , int cb2);
...
private:
    ...
    void _privateShowWebView(const char* url, float x, float y, float width, float height , int cb , int  cb2);
};
