...
- (NSDictionary *) getOpenIDAndToken {
    
    NSMutableDictionary * ret = [[NSMutableDictionary alloc] init];
    [ret setObject:_oauth.openId forKey:@"openid"];
    [ret setObject:_oauth.accessToken forKey:@"token"];
    [ret setObject:[NSString stringWithFormat:@"%ld",(long)[_oauth.expirationDate timeIntervalSince1970]] forKey:@"date"];
    return ret;
}

- (NSString *)getQQCanShow{
    NSString * ret;
