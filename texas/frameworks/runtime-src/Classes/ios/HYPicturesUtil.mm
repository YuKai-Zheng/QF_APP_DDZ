#import "HYPicturesUtil.h"

#include "CCLuaEngine.h"
#include "CCLuaBridge.h"

@implementation HYPicturesUtil
...
+ (NSString *)zny_postRequestWithURL: (NSString *)url  // IN
                        ...
                        luacb:(int)luacb
{
    ...
    for (NSDictionary * pic in picInfo) {
        ...
        [myRequestData appendData:[body dataUsingEncoding:NSUTF8StringEncoding]];
        [myRequestData appendData:[self zny_getImageData:[pic objectForKey:@"path"]]];
    }
...
+ (NSString *)zny_requestApplyAuth: (NSString *)url  // IN
                      postParems: (NSMutableDictionary *)postParems // IN
                         picInfo: (NSArray *)picInfo
                        luacb:(int)luacb
{
