...
void captureScreenToSpriteWithoutShader(const std::function<void(bool, Sprite* sprite)>& afterCaptured, bool quarter, int arg)
{
    s_sharder_type = SHADERTYPE_NONE;
    captureScreenToSprite(afterCaptured, quarter);
}
    
void captureScreenToSpriteWithBlur(const std::function<void(bool, cocos2d::Sprite* sprite)>& afterCaptured, bool quarter, unsigned int radius, int arg)
{
...
void captureScreenToSpriteWithGrey(const std::function<void(bool, cocos2d::Sprite* sprite)>& afterCaptured, bool quarter, int arg)
{
    s_sharder_type = SHADERTYPE_GREY;
    captureScreenToSprite(afterCaptured, quarter);
}

void captureScreenToSpriteWithHighlight(const std::function<void(bool, cocos2d::Sprite* sprite)>& afterCaptured, bool quarter, unsigned int increment, int arg)
{
