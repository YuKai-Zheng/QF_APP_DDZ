...
void ZYWebView::_privateShowWebView(const char* url, float x, float y, float width, float height , int cb , int cb2)
{
    m_webViewiOS = [[ZYWebView_iOS alloc] init];
    [m_webViewiOS setLuaCB:cb];
    [m_webViewiOS setLuaCB2:cb2];
