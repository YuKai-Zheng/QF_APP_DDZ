...
function IButton:setName(paras)
    ...
    if paras.index then
        local content = "";
        if paras.index == "501" then 
            content = GameTxt.string501 
        elseif paras.index == "502"  then 
            content = GameTxt.string502
        elseif paras.index == "503"  then 
            content = GameTxt.string503 
        end
