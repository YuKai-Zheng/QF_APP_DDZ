...
local VerifyIDCard = class("VerifyIDCard")
...
function VerifyIDCard:isBirthDate(date)
	-- body
...
function VerifyIDCard:isAllNumberOrWithXInEnd( str )
	-- body
	local ret = str:match("%d+X?") 
    return ret == str 
end

function VerifyIDCard:checkSum( idcard )
	-- body
...
function VerifyIDCard:verifyIDCard(idcard)
	-- body
